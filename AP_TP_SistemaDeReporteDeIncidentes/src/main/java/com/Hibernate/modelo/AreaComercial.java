...
public class AreaComercial {
	...
	private Cliente altaCliente() {
		System.out.println("Ingrese por favor su razon social");
		String razonSocial = scanner.nextLine();
		System.out.println("Ingrese por favor su cuit");
		String cuit = scanner.nextLine();
	...
	private void bajaCliente(Integer id) {
		...
		System.out.println("Como medida de seguridad ingrese su cuit tal como figura en su factura");
