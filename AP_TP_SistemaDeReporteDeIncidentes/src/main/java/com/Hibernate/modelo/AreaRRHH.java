...
public class AreaRRHH {
	...
	private void buscarNombreYMail() {
		...
		System.out.println("Por favor ingrese el mail: ");
	...
	private Tecnico altaTecnico() {
		System.out.println("Ingrese por favor el nombre del técnico ");
		String nombre = scanner.nextLine();
	...
	private void bajaTecnico() {
		System.out.println("Como medida de seguridad ingrese su mail tal como está registrado");
	...
	private void agregarEspecialidad() {
		System.out.println("Ingrese su nueva especialidad");
	...
	private void eliminarEspecialidad() {
		System.out.println("Ingrese la especialidad a eliminar");
		String especialidad = scanner.nextLine();
		tecnicoController.eliminarEspecialidad(this.tecnico.getId(), especialidad);
	}
